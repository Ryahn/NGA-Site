                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Pending Applications</h5>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Topics</h5>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Articles</h5>
